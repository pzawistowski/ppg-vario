...
void drawMain()
{
  ...
  sprite.drawString("TIME–AND–XXXX", 12, 14);
...
void mainScreen()
{
  ...
  {
    if (rtc.getSecond() < 10)
      secc = "0" + String(rtc.getSecond());
    else
      secc = String(rtc.getSecond());
    if (rtc.getMinute() < 10)
      minn = "0" + String(rtc.getMinute());
    else
      minn = String(rtc.getMinute());
    if (rtc.getMillis() / 10 < 10)
      mill = "0" + String(rtc.getMillis() / 10);
    else
      mill = String(rtc.getMillis() / 10);
  }
